...
def test_population_metrics_summary(population_metric_results: dict) -> None:
    """
    Test the population metrics average scores.

    :param population_metric_results: a tuple containing the metric class, the dataset type and a dictionary containing
      the **average** scores of the metric and the **detailed** scores

    :return: None
    """

    metric, which_data, scores = population_metric_results
...
def test_population_metrics_detailed(population_metric_results: dict) -> None:
    """
